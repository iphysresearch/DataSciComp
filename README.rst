...
<<<<<<< HEAD
比赛的简介：自定题目，使用提供的数据源。要求有创意。具体参考首页

+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| 比赛启发想法（总数据集页面：http://shanghai.sodachallenges.com/data.html#data-company）                                                                                                                                     | 状态     | 时间轴                   | 备注     |
+===================================================================================================================================================+==========+==========================+==========+
| `如何利用数据更好治理共享单车？  | 已结束   | 7月17日——8月8日    |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| `数据能用来鼓励更多绿色出行吗？   | 已结束   | 7月17日——8月8日    |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| `透过数据能知环境，但是否能治理环境？ | 已结束   | 7月17日——8月8日    |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| `如何利用数据高效监管食品安全，让市民吃的更放心？ | 已结束   | 7月17日——8月8日    |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| `企业商业行为如何通过数据去规范监督？| 已结束   | 7月17日——8月8日    |          |      |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| `航旅数据如何驱动新服务，带来体验提升？ | 已结束   | 7月17日——8月8日    |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| `如何利用数据高效节能智慧用电？ | 已结束   | 7月17日——8月8日    |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| `数据如何助力我们更好降低交通事故？ | 已结束   | 7月17日——8月8日    |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
...
大赛聚焦智慧医疗、科技金融两大垂直领域，共包含5大赛题，参赛者可根据兴趣，选择相应赛题参赛，并可同时参加多个比赛。
...
| 比赛项目                                                                                                                                          | 状态     | 时间轴                   | 备注     |
+===================================================================================================================================================+==========+==========================+==========+
| `苏州工业园区第八届高技能人才职业技能竞赛（算法类）  <http://www.jinji.hu/v2/v/24881820327739396/detail.jhtml>`__     | 进行中   | 08.15截至     |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| `苏州工业园区第八届高技能人才职业技能竞赛(决赛第二阶段)（算法类）  <http://www.jinji.hu/v2/v/25089396214596150/detail.jhtml>`__    | 进行中   | 08.15截至      |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
=======
+--------------------------------------------------------------------+----------+-----------------+--------+
| 比赛项目                                                           | 状态     | 时间轴          | 备注   |
...
| 数据支持                                                                                                                                         | 状态     | 时间轴                   | 备注     |
+===================================================================================================================================================+==========+==========================+==========+
| `基础的地理信息数据  | 进行中   | 08.15截至     |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
| `与生活密切相关的数据集  | 进行中   | 08.15截至      |          |
+---------------------------------------------------------------------------------------------------------------------------------------------------+----------+--------------------------+----------+
